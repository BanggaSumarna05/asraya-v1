...
$keywords = [
    ...
    "Rumah dijual di pekanbaru",
    "investasi rumah",
    "investasi rumah pekanbaru",
    "rumah aesthetics pekanbaru",
    "rumah minimalis pekanbaru",
    "hunian pekanbaru",
    "rumah mewah pekanbaru",
    "asri pekanbaru ** diolah lagi",
    "rumah asri pekanbaru",
    "rumah 1m pekanbaru",
    "rumah 2m pekanbaru",
    "rumah siap huni",
    "rumah untuk keluarga muda",
    "rumah di kota pekanbaru",
    "rumah dekat rumah sakit",
    "rumah dekat sekolah",
    "rumah dekat mall",
    "rumah dekat pusat kota",
    "rumah dekat bandara",
    "rumah furnished",
    "rumah smart home",
    ...
    "rumah terbaik di pekanbaru",
    "rumah terbaik di riau",
    "rumah smart home pekanbaru",
    "rumah smart lock",
    "rumah smart home system",
    "rumah tanpa perantara",
    "rumah anti banjir pekanbaru",
    "rumah tanpa banjir pekanbaru",

    // Investasi Rumah
    "investasi rumah",
    "investasi rumah pekanbaru",
    "investasi properti rumah pekanbaru",
    "rumah dijual untuk investasi",
    "rumah cocok untuk passive income",
    "peluang investasi rumah di pekanbaru",

    // Lokasi & Strategis
    "rumah di kota pekanbaru",
    "rumah strategis di pusat kota pekanbaru",
    "rumah premium di kota pekanbaru",
    "hunian elit pekanbaru",
    "rumah dekat fasilitas umum pekanbaru",
    "rumah dekat pusat kota",
    "rumah dekat rumah sakit",
    "rumah dekat sekolah",
    "rumah dekat mall",
    "rumah dekat bandara sultan syarif qasim",

    // Gaya & Estetika
    "rumah aesthetics pekanbaru",
    "rumah cantik dan aesthetics",
    "rumah minimalis pekanbaru",
    "rumah desain minimalis kekinian",
    "rumah bergaya skandinavia pekanbaru",
    "hunian modern tropis pekanbaru",

    // Kenyamanan & Lingkungan
    "rumah asri pekanbaru",
    "hunian asri pekanbaru",
    "rumah rindang dan nyaman pekanbaru",
    "rumah dengan suasana sejuk pekanbaru",
    "rumah dengan taman hijau alami",
    "rumah tenang jauh dari kebisingan",

    // Tipe & Harga Properti
    "rumah 1m pekanbaru",
    "rumah harga 1 miliar pekanbaru",
    "rumah 2m pekanbaru",
    "rumah mewah pekanbaru",
    "rumah eksklusif di pekanbaru",
    "rumah impian di bawah 2 miliar",

    // Fasilitas
    "rumah siap huni",
    "rumah lengkap dengan furniture",
    "rumah furnished",
    "rumah smart home",
    "rumah smart home pekanbaru",
    "rumah smart lock",
    ...
    // Target Pasar
    "rumah untuk keluarga muda",
    "rumah aman untuk anak-anak",
    "rumah nyaman untuk pasangan muda",
    "rumah pertama untuk milenial",

    // Keamanan & Resiko
    "rumah anti banjir pekanbaru",
    "rumah tanpa banjir pekanbaru",
    "rumah bebas banjir pekanbaru",
    "rumah di area tinggi pekanbaru",
    "rumah dengan sistem drainase bagus",
    ...
    "rumah terbaik di riau",
    "rumah tanpa perantara",
    "rumah langsung dari developer",
    "rumah dengan nilai jual tinggi",
    "rumah untuk gaya hidup modern",
    "rumah estetis dan fungsional"
    /*",
                "investasi rumah",
                "investasi rumah pekanbaru",
                "rumah aesthetics pekanbaru",
                ...
                ** cek dari pinhome
                deskripsi di rumah123 coba di sesuaikan lagi biar fit dengan google search
...
return [
    'meta' => [
         ...
         */
        'defaults'       => [
            'title'        => "Asraya Property", //"It's Over 9000!", // set false to total remove
            'titleBefore'  => true, // Put defaults.title before page title, like 'It's Over 9000! - Dashboard'
            'description'  => "Casa Asraya adalah tempat di mana keindahan desain bertemu kedamaian hutan dalam satu kesatuan hunian istimewa. Dikelilingi hijaunya pepohonan, dilengkapi fasilitas premium dan dirancang dengan arsitektur memikat. Nikmati hidup asri dan elegan hanya selangkah dari pusat kota. Āśraya (Sanskrit: आश्रय) arti mednalam dari 'āśraya' adalah perlindungan, naungan, tempat berlindung, dan keterikatan dengan kenyamanan dan keamanansumber daya. Dalam filosofi Hindu, entitas yang memiliki kehidupan / Jiva disebut āśraya. PT Casa Asraya Properti menciptakan hunian yang menjadi perlindungan yang nyaman dan membawa ketengan bagi penghuni didalam hunian. A PRESTIGIOUS ADDRESS IN THE ONE OF THE BIGGEST ECONOMIC CENTRE IN SUMATERA Kami menghadirkan perumahan premium yang mengutamakan desain modern dengan sentuhan alam, kami menciptakan hunian yang menggabungkan suasana hutan tropis di tengah hiruk-pikuk kota. Pesona Hutan Asraya memberikan pengalaman tinggal yang sejuk dan nyaman, dengan keseimbangan antara kenyamanan alam dan kemudahan akses ke pusat kehidupan perkotaan.",
            'separator'    => ' - ',
            'keywords'     => $keywords,
    ...
    'opengraph' => [
         ...
         */
        'defaults' => [
            'title'       => "Asraya Property",
            'description'  => "Casa Asraya adalah tempat di mana keindahan desain bertemu kedamaian hutan dalam satu kesatuan hunian istimewa. Dikelilingi hijaunya pepohonan, dilengkapi fasilitas premium dan dirancang dengan arsitektur memikat. Nikmati hidup asri dan elegan hanya selangkah dari pusat kota. Āśraya (Sanskrit: आश्रय) arti mednalam dari 'āśraya' adalah perlindungan, naungan, tempat berlindung, dan keterikatan dengan kenyamanan dan keamanansumber daya. Dalam filosofi Hindu, entitas yang memiliki kehidupan / Jiva disebut āśraya. PT Casa Asraya Properti menciptakan hunian yang menjadi perlindungan yang nyaman dan membawa ketengan bagi penghuni didalam hunian. A PRESTIGIOUS ADDRESS IN THE ONE OF THE BIGGEST ECONOMIC CENTRE IN SUMATERA Kami menghadirkan perumahan premium yang mengutamakan desain modern dengan sentuhan alam, kami menciptakan hunian yang menggabungkan suasana hutan tropis di tengah hiruk-pikuk kota. Pesona Hutan Asraya memberikan pengalaman tinggal yang sejuk dan nyaman, dengan keseimbangan antara kenyamanan alam dan kemudahan akses ke pusat kehidupan perkotaan.",
            'url'         => null, // Set null for using Url::current(), set false to total remove
            'type'        => "website",
            'site_name'   => "Asraya Property",
            'images'      => ["http://asrayaproperty.com/new/assets/img/cover-clubhouse-1.jpg"],
        ],
    ],
    'twitter' => [
        /*
