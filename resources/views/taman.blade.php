...
<head>
    ...
    <title>Taman Kota — Casa Asraya</title>
</head>
...
<body style="background:#f5f1ea; font-family:'Outfit',system-ui,sans-serif;">
    ...
    <section style="background:#1a3a2e; position:relative; overflow:hidden; min-height:65vh; display:flex; align-items:flex-end; padding:clamp(80px,18vw,140px) clamp(16px,4vw,48px) clamp(40px,6vw,64px);">
        ...
        <div style="position:relative;z-index:2; max-width:700px;">
            ...
            <p style="font-size:14px; color:rgba(255,255,255,0.7); margin:0; line-height:1.7;">Temukan energi semarak kota dan kedamaian alam di ruang publik yang asri.</p>
        </div>
    </section>
    ...
    <section style="background:#f5f1ea; padding:80px clamp(16px,4vw,48px);">
        <div class="container" style="padding-left:0;padding-right:0;">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7">
                    <p style="font-size:10px; font-weight:600; letter-spacing:0.25em; text-transform:uppercase; color:#D4622A; margin:0 0 12px;">Public Space</p>
                    <h2 style="font-family:'Outfit',sans-serif; font-size:clamp(1.5rem,3vw,2.2rem); font-weight:300; color:#1a3a2e; line-height:1.2; margin:0 0 24px;">Taman Terbuka Hijau</h2>
                    <p style="font-size:15px; color:#555; line-height:1.9; margin:0 0 16px;">
                        Jelajahi luar gerbang kami dan temukan energi semarak kota di taman tetangga kami. Terletak di belakang Mahoni, ruang publik yang dicintai ini disukai oleh penduduk dari segala usia karena fleksibilitasnya dalam mengakomodasi berbagai kegiatan.
                    </p>
                    <p style="font-size:15px; color:#555; line-height:1.9; margin:0 0 32px;">
                        Dari piknik santai keluarga hingga olahraga luar ruangan, benamkan diri Anda dalam permadani budaya Casa Asraya saat Anda menjelajahi berbagai kemungkinan yang menanti hanya beberapa langkah dari depan pintu Anda.
                    </p>
                    <a href="https://wa.me/6281319999806?text=Halo%20saya%20tertarik%20dengan%20info%20Taman%20Kota%20Casa%20Asraya" target="_blank"
