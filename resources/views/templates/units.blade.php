...
<body style="background:#f5f1ea; font-family:'Outfit',system-ui,sans-serif;">
    ...
    <section style="background:#1a3a2e; padding:140px clamp(16px,4vw,48px) 80px; position:relative; overflow:hidden; text-align:center;">
        ...
        <div style="position:relative;z-index:2; max-width:720px; margin:0 auto;">
            <p style="font-family:'Outfit',monospace; font-size:10px; font-weight:600; letter-spacing:0.28em; text-transform:uppercase; color:#D4622A; margin:0 0 16px;">Pilihan Hunian</p>
            ...
            <p style="font-size:14.5px; color:rgba(255,255,255,0.7); line-height:1.8; max-width:540px; margin:0 auto;">
                Casa Asraya adalah tempat di mana keindahan desain bertemu kedamaian hutan dalam satu kesatuan hunian istimewa.
            </p>
        </div>
    </section>
                        ...
                        <div class="unit-card">
                            ...
                            <div class="unit-info">
                                ...
                                <p style="font-size:14px; color:#666; line-height:1.7; margin:0 0 28px;">
                                    Hunian 3 lantai berarsitektur modern tropis rancangan Atelier Riri, menyatu harmonis dengan kesejukan alam sekitar.
                                </p>
